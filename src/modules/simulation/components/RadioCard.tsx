...
export const RadioCard = ({ id, label, value, name, onClick }: Props) => {

    return (
        <label htmlFor={id} className="cursor-pointer">
            <input type="radio" id={id} name={name} value={value} className="peer hidden" onClick={ onClick }/>
